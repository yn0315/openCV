...
#
learning_rate = 0.001 
training_epochs = 20 # 학습횟수
batch_size = 100 # 100개씩 잘라서 학습하겠다
...
fc1 = tf.contrib.layers.flatten(pool2) # 한줄로 쭉 펴주는
...
optimizer = tf.train.AdamOptimizer(learning_rate).minimize(cost) # 최적화
