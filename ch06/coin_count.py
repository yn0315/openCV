...
if circles is not None:
    for i in range(circles.shape[1]): # 원의 갯수
        cx, cy, radius = np.uint16(circles[0][i]) # i번째 원의 중심점과 반지름
        ...
        hue_shift = (hue + 40) % 180 # 180보다 커지면 0부터 다시 시작하도록
