...
for pts in contours:
    ...
    # countour2 - 두 번째 외곽선 또는 그레이스케일 영상
    # method - 비교 방법 지정. cv2.CONTOURS_MATCH_I1, cv2.CONTOURS_MATCH_I2,cv2.CONTOURS_MATCH_I3 중 하나 사용. I3추천
    # parameter - 사용되지 않음. 0 지정
    # retval - 두 외곽선 또는 그레이스케일 영상 사이의 거리(distance) 실수형
